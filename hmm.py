...
A, B_mean, B_var, pi, averages_x, variances_x = initialize_hmm.init_par(y_train)
...
def activity_sequence(i, activityIndex, x, n):
...
def initialize_GMM(x, n_Gauss):
  ...
  # n is the number of Gaussian distributions per state  
  kmeans = KMeans(n_clusters = n_Gauss, random_state = 0).fit(x)
  return kmeans
